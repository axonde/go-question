...
abstract class $UserProfileCopyWith<$Res> {
  ...
  @useResult
  $Res call({String uid, String name, int age, int visitedEventsCount});
}
...
class _$UserProfileImpl implements _UserProfile {
  ...
  @override
  String toString() {
    return 'UserProfile(uid: $uid, name: $name, age: $age, visitedEventsCount: $visitedEventsCount)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, uid, name, age, visitedEventsCount);
...
abstract class _UserProfile implements UserProfile {
  const factory _UserProfile({
    ...
    required final int visitedEventsCount,
  }) = _$UserProfileImpl;
